/**
 * Centralized external links to avoid magic strings across components.
 * Update these in one place to reflect project changes consistently.
 */
export const DISCORD_URL = "https://discord.gg/NqwTqVYVmj";

/** Canonical repository for LichtFeld Studio (README, issues, stars). */
export const GITHUB_REPO_URL = "https://github.com/MrNeRF/LichtFeld-Studio";
