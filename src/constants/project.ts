...
export const CONTRIBUTION_PROJECT_VIEW_URL = `https://github.com/users/${REPO_OWNER}/projects/${CONTRIBUTION_PROJECT_NUMBER}/views/${CONTRIBUTION_PROJECT_VIEW_NUMBER}`;
